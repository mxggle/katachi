...
describe('root layout app icons', () => {
  ...
  it('renders the precomposed apple touch icon link before the body for Safari add-to-home-screen', () => {
  ...
  it('declares manifest and standalone metadata through the Next metadata API', () => {
    ...
    expect(layoutSource).toContain("title: 'Katachi'");
  });
});
